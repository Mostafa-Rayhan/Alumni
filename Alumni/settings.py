...
SECRET_KEY = 'django-insecure-csmko138+277$bar$wf5&a4kac9+=1a#en(y8*rofwo6buy$3p'
...
MIDDLEWARE = [
    ...
    'social_django.middleware.SocialAuthExceptionMiddleware',    # new add
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.backends',     # new add
